...
import { LayoutDashboard, Building2, PlusCircle, CalendarCheck2, Wallet } from "lucide-react";

const links = [
  { to: "/host/dashboard", label: "Dashboard", icon: LayoutDashboard, end: true },
  { to: "/host/properties", label: "My Properties", icon: Building2 },
  { to: "/host/properties/new", label: "Add Property", icon: PlusCircle },
  { to: "/host/bookings", label: "Bookings", icon: CalendarCheck2 },
];
